...
@NgModule({
  ...
  imports:      [ BrowserModule,FormsModule,CarouselModule.forRoot(),RouterModule.forRoot([{path:'#/welcome',component:WelcomeComponent},{path:'#/flowers',component:FlowerListComponent},{path:'#/customers',component:CustomerListComponent}],{useHash:true})],
